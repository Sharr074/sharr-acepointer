...
$i++;
$cfg['Servers'][$i]['host'] 			= 'global-db:3306';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= '[vQc4B\'Qm/Z9C-\\2>6.G8EQX1zCK|7g1' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_E5hDKHWbZI9yXjdr2l6speo/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
